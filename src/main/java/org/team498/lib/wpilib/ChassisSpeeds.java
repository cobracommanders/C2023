...
public class ChassisSpeeds extends edu.wpi.first.math.kinematics.ChassisSpeeds {
    ...
    public static ChassisSpeeds fromFieldRelativeSpeeds(double vxMetersPerSecond, double vyMetersPerSecond, double omegaRadiansPerSecond, double robotAngle) {
    ...
    public static edu.wpi.first.math.kinematics.ChassisSpeeds fromFieldRelativeSpeeds(edu.wpi.first.math.kinematics.ChassisSpeeds fieldRelativeSpeeds, double robotAngle) {
        return fromFieldRelativeSpeeds(fieldRelativeSpeeds.vxMetersPerSecond, fieldRelativeSpeeds.vyMetersPerSecond, fieldRelativeSpeeds.omegaRadiansPerSecond, robotAngle);
    }

    public static ChassisSpeeds toFieldRelativeSpeeds(double vxMetersPerSecond, double vyMetersPerSecond, double omegaRadiansPerSecond, Rotation2d robotAngle) {
    ...
    public static ChassisSpeeds toFieldRelativeSpeeds(ChassisSpeeds fieldRelativeSpeeds, Rotation2d robotAngle) {
        return toFieldRelativeSpeeds(fieldRelativeSpeeds.vxMetersPerSecond, fieldRelativeSpeeds.vyMetersPerSecond, fieldRelativeSpeeds.omegaRadiansPerSecond, robotAngle);
    }
