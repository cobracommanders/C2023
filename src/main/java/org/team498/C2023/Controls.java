...
public class Controls {
    ...
    public void configureOperatorCommands() {
        ...
        operator.rightTrigger().toggleOnTrue(new ConditionalCommand(new InstantCommand(()-> robotState.setState(State.SPIT_CUBE)), new InstantCommand(()-> robotState.setState(State.IDLE_CUBE)), ()-> robotState.getState() == State.IDLE_CUBE).andThen(new ParallelCommandGroup(
