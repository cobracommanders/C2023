package org.team498.C2023.commands.drivetrain.archive;

import java.util.function.DoubleSupplier;

import org.team498.C2023.Constants.DrivetrainConstants;
import org.team498.C2023.DriverController;
...
public class FieldOrientedDrive extends CommandBase {
	...
	@Override
	public void execute() {
		double driveSpeed = slowDrive.getAsBoolean() ? 0.5 : 1;
		...
		drivetrain.drive(xTranslation, yTranslation, rotation);
	}
