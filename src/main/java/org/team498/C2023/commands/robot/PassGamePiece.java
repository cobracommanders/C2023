...
import org.team498.C2023.commands.elevator.MoveToPassPosition;
...
import org.team498.C2023.commands.wrist.RotateToPassPosition;

public class PassGamePiece extends SequentialCommandGroup {
    public PassGamePiece() {
        super(
            new ParallelCommandGroup(
                    new RotateToPassPosition(),
                    new MoveToPassPosition()
            ),
